...
// Aufgabe 3) Speicherorganisation
// Geben sie in der Kommandozeile 'dump mat1' zur Ausgabe des Speicherabbildes
// der Matrix1 ein. Fügen sie das Speicherabbild hier ein und ordnen sie die Speicherinhalte
// zu dem Matrixinhalt von mat1 zu
...
int main(int argc, char const *argv[])
{
    ...
    while (1)
    {
        ...
        else if ((strcmp(arg1, "dump") == 0) && (arg2 != NULL))
        {
            ...
            if (strcmp(arg2, "mat2") == 0)
                dump(mat1, sizeof(mat2), 16, DUMP_8);
        }
